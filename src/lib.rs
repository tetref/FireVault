...
#[derive(Debug)]
pub struct FireVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FireVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FireVault processing");
    
    let mut processor = FireVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FireVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FireVaultProcessor::new(false);
